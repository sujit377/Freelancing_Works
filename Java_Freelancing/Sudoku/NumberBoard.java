...
public class NumberBoard {
	 ...
	 * 
	 * @param rows    the number of rows. Must be {@code >= 1}.
	 * @param columns the number of columns. Must be {@code >= 1}.
	 * @throws IllegalArgumentException if rows or columns are below 1.
	 */
	 ...
	 * 
	 * @param row the cell's row, starting at 0.
	 * @param col the cell's column, starting at 0.
	 * @return the value in the cell, which may be {@link #EMPTY}. Will also return
	 *         {@link #EMPTY} if the coordinates are out of range.
	 */
	 ...
	 * @param row   the cell's row, starting at 0.
	 * @param col   the cell's column, starting at 0.
	 * @param value the cell's value. Must be {@code >= 0} or {@link #EMPTY}.
	 */
	 ...
	 * @param row the cell's row, starting at 0.
	 * @param col the cell's column, starting at 0.
	 * @return {@code true} if the coordinate is in range, {@code false}  otherwise.
	 */
